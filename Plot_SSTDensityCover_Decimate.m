...
% 12-15-15                                                           %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function Plot_SSTDensityCover_Decimate(psw2, time, temp, lat, lon, RCP, ...
            hist, C, S, Data, I, gi, dCov, ri, SGPath, outputPath, k, pdfDirectory, LOC, ...
    ...
    if nargin == 0
        ...
        close all;
        clearvars figHandle DHM Time plotDHM1 plotDHM2 plotSST1 plotSST2 plotSD1 plotSD2 plotCC1 scatCC2 scatCC1; 
        return;
    end
